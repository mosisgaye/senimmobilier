export default function TestPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-500 to-purple-600 flex items-center justify-center p-8">
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="bg-emerald-500 text-white p-4 rounded-lg text-center">Bleu</div>
        </div>
